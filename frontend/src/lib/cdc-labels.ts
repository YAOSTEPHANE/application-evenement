...
/** Libellés courts (kanban, compteurs) */
...
export const BE_SUBTYPE_LABELS: Record<BeSubtype, string> = {
  ...
  BE_RET: "BE-RET — Retour prestation événement",
  BE_TRF: "BE-TRF — Réception transfert inter-sites",
  BE_REP: "BE-REP — Réintégration après réparation",
};
